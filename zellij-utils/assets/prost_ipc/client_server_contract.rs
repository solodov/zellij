...
#[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum ActionType {
        ...
        /// Zacme fork actions use a high tag range to avoid upstream action collisions.
...
pub struct Options {
    ...
    /// Fork-only options use high tags to avoid upstream field collisions.
    #[prost(string, optional, tag="900")]
    pub copy_on_select_command: ::core::option::Option<::prost::alloc::string::String>,
}
