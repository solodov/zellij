...
const ACME_TEXT: PaletteColor = PaletteColor::Rgb((0x12, 0x18, 0x12));
const ACME_MUTED_TEXT: PaletteColor = PaletteColor::Rgb((0x45, 0x58, 0x49));
const ACME_TAB_GREEN: PaletteColor = PaletteColor::Rgb((0x1f, 0x5b, 0x2a));
const ACME_TAB_GREEN_LIGHT: PaletteColor = PaletteColor::Rgb((0xe4, 0xf6, 0xd3));
const ACME_TITLE_BLUE: PaletteColor = PaletteColor::Rgb((0x5a, 0xae, 0xc6));
const ACME_TITLE_BLUE_LIGHT: PaletteColor = PaletteColor::Rgb((0xdd, 0xf7, 0xff));
const ACME_PURPLE: PaletteColor = PaletteColor::Rgb((0x5f, 0x3d, 0xd6));
const ACME_PURPLE_MUTED: PaletteColor = PaletteColor::Rgb((0x75, 0x60, 0xb8));
const ACME_WARNING: PaletteColor = PaletteColor::Rgb((0xb8, 0x65, 0x2b));
const ACME_ERROR: PaletteColor = PaletteColor::Rgb((0x9a, 0x3f, 0x35));
const ACME_PANEL_BACKGROUND: PaletteColor = PaletteColor::Rgb((0xf4, 0xf7, 0xe8));

pub const DEFAULT_STYLES: Styling = Styling {
    text_unselected: StyleDeclaration {
        base: ACME_TEXT,
        emphasis_0: ACME_PURPLE,
        emphasis_1: ACME_TITLE_BLUE,
        emphasis_2: ACME_TITLE_BLUE,
        emphasis_3: ACME_PURPLE_MUTED,
        background: ACME_PANEL_BACKGROUND,
    },
    text_selected: StyleDeclaration {
        base: ACME_TEXT,
        emphasis_0: ACME_PURPLE,
        emphasis_1: ACME_TITLE_BLUE,
        emphasis_2: ACME_TAB_GREEN,
        emphasis_3: ACME_PURPLE_MUTED,
        background: ACME_TITLE_BLUE_LIGHT,
    },
    ribbon_unselected: StyleDeclaration {
        base: ACME_TAB_GREEN,
        emphasis_0: ACME_ERROR,
        emphasis_1: ACME_TEXT,
        emphasis_2: ACME_TITLE_BLUE,
        emphasis_3: ACME_PURPLE_MUTED,
        background: ACME_TAB_GREEN_LIGHT,
    },
    ribbon_selected: StyleDeclaration {
        base: ACME_TAB_GREEN_LIGHT,
        emphasis_0: ACME_ERROR,
        emphasis_1: ACME_WARNING,
        emphasis_2: ACME_PURPLE,
        emphasis_3: ACME_TITLE_BLUE,
        background: ACME_TAB_GREEN,
    },
    exit_code_success: StyleDeclaration {
        base: ACME_TAB_GREEN,
        emphasis_0: ACME_TITLE_BLUE,
        emphasis_1: ACME_TEXT,
        emphasis_2: ACME_PURPLE_MUTED,
        emphasis_3: ACME_TITLE_BLUE,
        background: ACME_PANEL_BACKGROUND,
    },
    exit_code_error: StyleDeclaration {
        base: ACME_ERROR,
        emphasis_0: ACME_WARNING,
        emphasis_1: ACME_TEXT,
        emphasis_2: ACME_MUTED_TEXT,
        emphasis_3: ACME_PURPLE_MUTED,
        background: ACME_PANEL_BACKGROUND,
    },
    ...
    frame_selected: StyleDeclaration {
        ...
        emphasis_1: ACME_TITLE_BLUE,
        emphasis_2: ACME_PURPLE_MUTED,
        emphasis_3: ACME_WARNING,
        background: ACME_PANEL_BACKGROUND,
    },
    frame_highlight: StyleDeclaration {
        base: ACME_PURPLE,
        emphasis_0: ACME_PURPLE_MUTED,
        emphasis_1: ACME_WARNING,
        emphasis_2: ACME_TAB_GREEN,
        emphasis_3: ACME_TAB_GREEN,
        background: ACME_TAB_GREEN_LIGHT,
    },
    ...
    multiplayer_user_colors: MultiplayerColors {
        player_1: ACME_PURPLE,
        player_2: ACME_TITLE_BLUE,
        player_3: ACME_TAB_GREEN,
        player_4: ACME_WARNING,
        player_5: ACME_PURPLE_MUTED,
        player_6: PaletteColor::Rgb((0x6e, 0x99, 0x6e)),
        player_7: ACME_ERROR,
        player_8: ACME_MUTED_TEXT,
        player_9: PaletteColor::Rgb((0xc0, 0x76, 0xa8)),
        player_10: PaletteColor::Rgb((0x8a, 0x65, 0x3d)),
    },
};
