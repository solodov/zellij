...
fn test_client_messages() {
    ...
    test_client_roundtrip!(ClientToServerMsg::FirstClientConnected {
        cli_assets: CliAssets {
            ...
            configuration_options: Some(Options {
                ...
                copy_on_select_command: Some("clipboard --autogenerated".to_owned()),
    ...
    test_client_roundtrip!(ClientToServerMsg::Action {
        action: Action::NewAcmeColumn,
        terminal_id: Some(1),
        client_id: Some(100),
        is_cli_client: true,
    });
    test_client_roundtrip!(ClientToServerMsg::Action {
        action: Action::NewAcmePane,
        terminal_id: Some(1),
        client_id: Some(100),
        is_cli_client: true,
    });
    test_client_roundtrip!(ClientToServerMsg::Action {
        action: Action::AcmeMaximizePane,
        terminal_id: Some(1),
        client_id: Some(100),
        is_cli_client: true,
    });
    test_client_roundtrip!(ClientToServerMsg::Action {
        action: Action::EqualizeAcmeColumns,
        terminal_id: Some(1),
        client_id: Some(100),
        is_cli_client: true,
    });
